...
This documentation provides detaild description on how to use the module, with example codes and links to example files. Detailed description is available in the [docs folder](https://github.com/RRichardB/TCAMpy/tree/main/docs).
